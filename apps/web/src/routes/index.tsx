          ...
          <nav className="flex items-center gap-4">
            {isSignedIn ? (
              ...
              <>
                <Link
                  to="/auth/login"
                  className="text-sm text-foreground hover:text-foreground border-b border-border px-6 py-3 rounded-md  hover:bg-accent transition-all"
                >
                  Sign in
                </Link>
              </>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 gradient-subtle">
        <div className="max-w-2xl text-center py-20 my-8">
          ...
          <p className="text-lg text-muted-foreground mb-4 leading-relaxed max-w-lg mx-auto">
            A precision instrument for measuring, tracking, and expanding your vocabulary in 65 languages.
          </p>
          <p className="text-sm text-muted-foreground mb-10 max-w-md mx-auto">
            Test against the 10,000 most important words. Find gaps. Fill them. Accurately track your CEFR level.
          </p>
        ...
        <div className="w-full max-w-3xl mx-auto pb-20">
          <div className="grid grid-cols-3 gap-6 text-center">
            <div className="space-y-1">
              ...
              <div className="text-xs text-muted-foreground uppercase tracking-wider">words per language</div>
            </div>
            <div className="space-y-1 border-x border-border px-4">
              <div className="text-4xl font-bold font-mono tracking-tighter">A1–C2</div>
              <div className="text-xs text-muted-foreground uppercase tracking-wider">CEFR tracking</div>
            </div>
            <div className="space-y-1">
      ...
      <section id="how-it-works" className="border-t border-border py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-mono text-muted-foreground uppercase tracking-widest mb-3">Methodology</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed pl-11">
                Quick multiple-choice tests rapidly narrow down your vocabulary level using binary search. Know your
                number in minutes, not hours.
              </p>
            </div>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed pl-11">
                A heatmap of your vocabulary reveals exactly which words you're missing. See the holes. Prioritize what
                matters most.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed pl-11">
                Translation tests with real sentences. AI-powered spaced repetition. Every session is a precision
                strike.
              </p>
            </div>
          </div>
