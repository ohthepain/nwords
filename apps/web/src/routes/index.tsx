    ...
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 gradient-subtle">
        <div className="max-w-2xl text-center py-20 my-8">
          ...
          <p className="text-md text-muted-foreground mb-10 max-w-md mx-auto py-2">
          ...
          <HomeLanguagePairSection
            ...
            accountNativeLanguageId={account?.nativeLanguage?.id}
            accountTargetLanguageId={account?.targetLanguage?.id}
          />
        </div>
