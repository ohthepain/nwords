						...
						<form onSubmit={handleSubmit} className="space-y-5 mt-6">
							...
							<div>
								...
								<input
									...
									required
									autoComplete="name"
									className="w-full px-4 py-3 rounded-xl border border-input bg-background text-foreground placeholder:text-muted-foreground text-sm outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-all"
								/>
							</div>
