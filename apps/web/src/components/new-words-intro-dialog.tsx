						...
						<DialogDescription className="text-base text-foreground/85">
							{canBeginPractice ? (
								...
								<>
									...
									<span className="font-semibold text-foreground">{words.length}</span> lemmas at
									the edge of your territory. They have curated sentence IDs, but none are wired
									for cloze yet (missing or mismatched sentence links, removed sentences, or
									language filters). A listed new-words session can&apos;t start for this batch. Use
									general Build vocabulary for now, or fix links in the corpus pipeline.
								</>
							) : (
								<>
									Column {columnIndex + 1} on your heatmap is open with{" "}
