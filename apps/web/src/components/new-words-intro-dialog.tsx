              ...
              {introKind === "intro_backlog" ? (
                canBeginPractice ? (
                  <>
                    ...
                    untested, clozable lemmas in the active band — enough that we batch the next few instead of
                    dropping you on one at random. Up to{" "}
                    <span className="font-semibold text-foreground">{practiceLemmaCount}</span> in rank order (same short
                    pass as column practice), then normal Build again.
                  </>
                ) : showCuratedUnlinkedCopy ? (
                  <>
                    This batch doesn&apos;t have cloze-ready sentences yet. Stay on general Build, or fix sentence
                    links for these lemmas.
                  </>
                ) : (
                ...
                practiceLemmaCount === words.length ? (
                  <>
                    ...
                    <span className="font-semibold text-foreground">{words.length}</span> fresh lemmas at the edge of
                    what you&apos;ve conquered — short, focused, and right where you&apos;re growing.
                  </>
                ) : (
                  <>
