...
const EMPTY_TARGET_LANGUAGES_HINT =
	...
	return (
		<div className="space-y-5">
			...
			{targetLanguages.length === 0 ? (
				<p className="text-xs text-foreground bg-muted rounded-md px-3 py-2">
					{EMPTY_TARGET_LANGUAGES_HINT}
				</p>
			) : null}

			{measureBuild && targetValue ? (
				<div className="rounded-lg border border-border/80 bg-muted/25 px-4 py-3 space-y-3">
					<Button
						type="button"
